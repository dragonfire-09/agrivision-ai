   ...
   with tab1:
    ...
    if uploaded:
        ...
        with d4:
            ...
            c.drawString(50, ph - 50, "AgriVision AI Pro - Analysis Report")
            ...
            c.drawString(70, y - 28, f"Weeds: {wc}")
            c.drawString(70, y - 50, f"Crops: {cc}")
            c.drawString(70, y - 72, f"Density: {wd:.1f}%")
            c.drawString(70, y - 94, f"Confidence: {ac:.0%}")
            if wd > 30:
                risk_txt = "CRITICAL - Immediate action required!"
            elif wd > 20:
                risk_txt = "HIGH - Herbicide recommended"
            elif wd > 10:
                risk_txt = "MEDIUM - Targeted treatment"
            elif wc > 0:
                risk_txt = "LOW - Preventive measures"
            else:
                risk_txt = "CLEAN - Field is healthy"
            c.setFont("Helvetica-Bold", 13)
            c.drawString(70, y - 124, f"Risk Level: {risk_txt}")
            c.setFont("Helvetica", 9)
            c.drawString(50, 30, "Generated by AgriVision AI Pro v4.0")
            c.save()
            pdf_buf.seek(0)
